"""
Django settings for sala_situacional project.
...
SECRET_KEY = '--@j4ocg$4t6p$@)e54sc51acrqmzoh9p21)2l5&b6i)pxdz+n'
...
ROOT_URLCONF = 'sala_situacional.urls'
...
WSGI_APPLICATION = 'sala_situacional.wsgi.application'
